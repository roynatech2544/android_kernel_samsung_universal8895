...
void trace_printk_init_buffers(void)
{
	...
	pr_warning("**                                                      **\n");
	pr_warning("** If by any chance you are seeing this and you are     **\n");
	pr_warning("** using other than hadesRom and hadesKernel means that **\n");
	pr_warning("** this is just a big ass kang of hadesKernel, probably **\n");
	pr_warning("** running on a big kang of hadesRom...                 **\n");
	pr_warning("**                                                      **\n");
	pr_warning("** Given the fact that this doesn't come from trusted   **\n");
	pr_warning("** sources, you are advised to immediately switch to    **\n");
	pr_warning("** something else.                                      **\n");
	pr_warning("**                                                      **\n");
	pr_warning("** Get more info from bit.ly/hadesRom                   **\n");
	pr_warning("**                                                      **\n");
	pr_warning("**   NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE   **\n");
	pr_warning("**********************************************************\n");
